...
```{r}
data <- read.csv("./input/auto-mpg.csv",
                 header = T,
                 na.strings = "?",
...
plot(model)
```
[About visreg](https://pbreheny.github.io/visreg/)
...
# MSE
print(sprintf("Mean of squared errors (MSE): %.3f", sqrt(mean((predictions - testData$mpg)^2))))
# R2 score
print(sprintf("R2 score: %.3f", R2(predictions, testData$mpg)))
